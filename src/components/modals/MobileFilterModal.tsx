          ...
          >
            <div className={`p-6 border-b shrink-0 flex items-center justify-between ${themeClasses.border}`}>
              <div>
                ...
                <p className={`text-[10px] ${themeClasses.textMuted} mt-0.5 font-medium capitalize tracking-widest`}>Sesuaikan tampilan antrian</p>
              </div>
              <button 
                onClick={onClose}
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-400 capitalize tracking-widest ml-1">Cari Tiket</label>
              ...
              {/* Department Filter */}
              <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-400 capitalize tracking-widest ml-1">Bagian / Departemen</label>
              ...
              {/* Status Filter */}
              <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-400 capitalize tracking-widest ml-1">Status Tiket</label>
                <div className="flex flex-wrap gap-2">
                  <button 
              ...
              {/* Date Filter */}
              <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-400 capitalize tracking-widest ml-1">Tanggal Spesifik</label>
                <div className="relative">
            ...
            <div className={`p-6 border-t shrink-0 flex gap-3 ${
              ...
              <button 
                onClick={onReset}
                className={`flex-1 py-4 font-black text-[10px] capitalize tracking-widest rounded-2xl transition-all ${
              ...
              <button 
                onClick={onApply}
                className={`flex-[2] py-4 text-white font-black text-[10px] capitalize tracking-widest rounded-2xl shadow-lg transition-all active:scale-[0.98] ${
