...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const cardClass = `${isDark ? 'bg-[#1e2330] border-[#2a3142]' : 'bg-white border-slate-200'} border rounded-[var(--admin-btn-radius,14px)] p-5 shadow-sm`;
  ...
  return (
    <div className="space-y-3 sm:space-y-4 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {/* Card 1: Semua Tiket */}
        <div className={`p-4 sm:p-5 rounded-[var(--admin-btn-radius,14px)] border shadow-sm flex items-center justify-between ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[var(--admin-btn-radius,14px)] bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center flex-shrink-0">
        ...
        <div className={`p-4 sm:p-5 rounded-[var(--admin-btn-radius,14px)] border shadow-sm flex items-center justify-between ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[var(--admin-btn-radius,14px)] bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center flex-shrink-0 relative">
            {stats.baru > 0 && (
        ...
        <div className={`p-4 sm:p-5 rounded-[var(--admin-btn-radius,14px)] border shadow-sm flex items-center justify-between ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[var(--admin-btn-radius,14px)] bg-orange-500/10 text-orange-600 dark:text-orange-400 flex items-center justify-center flex-shrink-0">
        ...
        <div className={`p-4 sm:p-5 rounded-[var(--admin-btn-radius,14px)] border shadow-sm flex items-center justify-between ${isDark ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
          ...
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-[var(--admin-btn-radius,14px)] bg-purple-500/10 text-purple-600 dark:text-purple-400 flex items-center justify-center flex-shrink-0">
